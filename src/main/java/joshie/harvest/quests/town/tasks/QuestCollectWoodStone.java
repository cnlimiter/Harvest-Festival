...
public class QuestCollectWoodStone extends QuestDaily {
	...
	public String getDescription(World world, @Nullable EntityPlayer player) {
		if (player != null) {
			return getLocalized("desc", amount, (wood ? getLocalized("wood") : getLocalized("stone")));
		} else {
			return getLocalized(
					"task", amount, (wood ? getLocalized("wood") : getLocalized("stone")),
					(
	...
	public void onQuestCompleted(EntityPlayer player) {
		...
		rewardItem(
				player, (
						wood ? HFTools.AXES.get((silver ? ToolTier.SILVER : ToolTier.COPPER)).getStack() :
