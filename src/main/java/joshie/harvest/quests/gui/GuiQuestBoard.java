...
public class GuiQuestBoard extends GuiBaseContainer {
	...
	public void initGui() {
		super.initGui();
		if (quest != null && !TownHelper.getClosestTownToEntity(MCClientHelper.getPlayer(), false)
				.getQuests()
				.getCurrent()
				.contains(quest)) {
	...
	public void drawForeground(int x, int y) {
		if (quest != null) {
			...
			fontRenderer.drawSplitString(StringEscapeUtils.unescapeJava(TextHelper.translate("quest.none")), 42, 38, 142, 4210752);
		}
	}
}
