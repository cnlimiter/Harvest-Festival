...
public class PurchasableCropSeeds implements IPurchasable {
	...
	public void addTooltip(List<String> list) {
		list.addAll(getDisplayStack().getTooltip(MCClientHelper.getPlayer(), TooltipFlags.NORMAL));
		...
		if (crop.getRegrowStage() > 0) {
			list.add(TextHelper.formatHF("crop.seeds.shop.regrow", (crop.getStages() - crop.getRegrowStage())));
		}
	}
