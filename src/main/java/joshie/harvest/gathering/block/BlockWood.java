...
public class BlockWood extends BlockHFSmashable<BlockWood, Wood> {
	...
	public void getDrops(NonNullList<ItemStack> drops, EntityPlayer player, World world, BlockPos pos, IBlockState state, float luck) {
		...
		switch (type) {
			case BRANCH_SMALL:
				drops.add(new ItemStack(Blocks.LOG, 1));
				break;
			case BRANCH_MEDIUM:
				drops.add(new ItemStack(Blocks.LOG, 2));
				break;
			case BRANCH_LARGE:
				drops.add(new ItemStack(Blocks.LOG, 6));
				break;
			case STUMP_SMALL:
				drops.add(new ItemStack(Blocks.LOG, 3));
				break;
			case STUMP_MEDIUM:
				drops.add(new ItemStack(Blocks.LOG, 4));
				break;
			case STUMP_LARGE:
				drops.add(new ItemStack(Blocks.LOG, 12));
				break;
		}
	}
