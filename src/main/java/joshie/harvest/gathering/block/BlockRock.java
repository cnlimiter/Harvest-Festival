	...
	public void getDrops(NonNullList<ItemStack> drops, EntityPlayer player, World world, BlockPos pos, IBlockState state, float luck) {
		switch (getEnumFromState(state)) {
			case STONE_SMALL:
				...
				break;
			case STONE_MEDIUM:
				drops.add(new ItemStack(Blocks.STONE, 2));
				break;
			case STONE_LARGE:
				drops.add(new ItemStack(Blocks.STONE, 4));
				break;
			case BOULDER_SMALL:
				drops.add(new ItemStack(Blocks.STONE, 3));
				break;
			case BOULDER_MEDIUM:
				drops.add(new ItemStack(Blocks.STONE, 6));
				break;
			case BOULDER_LARGE:
				drops.add(new ItemStack(Blocks.STONE, 12));
				break;
		}
	}
}