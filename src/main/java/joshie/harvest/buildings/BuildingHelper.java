...
public class BuildingHelper {
	...
	public static BuildingKey getPositioning(
	...
	public static ActionResult<ItemStack> displayErrors(World world, @Nonnull ItemStack stack, List<BuildingError> errors) {
		if (world.isRemote) {
			...
			for (int i = 0; i < errors.size(); i++) {
				String string =
						TextFormatting.RED + TextHelper.translate("town.failure") + " " + TextFormatting.WHITE + TextHelper.translate(
								"town." + errors.get(i).name().toLowerCase(Locale.ENGLISH));
