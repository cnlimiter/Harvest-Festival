...
public class HFBuildings {
    ...
    public static final Building BLACKSMITH = registerBuilding("blacksmith").setRequirements("mining_hill").setInhabitants(HFNPCs.BLACKSMITH).setOffset(3, -2, 6);
    ...
    public static final Building FISHING_HUT = registerBuilding("fishing_hut").setRequirements("barn", "poultry_farm").setInhabitants(HFNPCs.FISHERMAN).setOffset(6, -1, 8);
    public static final Building GODDESS_POND = registerBuilding("goddess_pond").setSpecialRules(new SpecialRuleBuildings(5)).setInhabitants(HFNPCs.GODDESS).setOffset(11, -1, 20);
    public static final Building MINING_HILL = registerBuilding("mining_hill").setRequirements("supermarket").setInhabitants(HFNPCs.MINER).setOffset(10, -3, 11);
