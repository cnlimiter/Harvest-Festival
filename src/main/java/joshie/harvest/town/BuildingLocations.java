...
import static joshie.harvest.buildings.HFBuildings.BARN;
import static joshie.harvest.buildings.HFBuildings.BLACKSMITH;
import static joshie.harvest.buildings.HFBuildings.CAFE;
import static joshie.harvest.buildings.HFBuildings.CARPENTER;
import static joshie.harvest.buildings.HFBuildings.CHURCH;
import static joshie.harvest.buildings.HFBuildings.CLOCKMAKER;
import static joshie.harvest.buildings.HFBuildings.FESTIVAL_GROUNDS;
import static joshie.harvest.buildings.HFBuildings.FISHING_HOLE;
import static joshie.harvest.buildings.HFBuildings.FISHING_HUT;
import static joshie.harvest.buildings.HFBuildings.GODDESS_POND;
import static joshie.harvest.buildings.HFBuildings.MINING_HILL;
import static joshie.harvest.buildings.HFBuildings.POULTRY_FARM;
import static joshie.harvest.buildings.HFBuildings.SUPERMARKET;
import static joshie.harvest.buildings.HFBuildings.TOWNHALL;
...
public class BuildingLocations {
	...
	public static final BuildingLocation CLOCKMAKER_WORK = new BuildingLocation(CLOCKMAKER, "clockworker.work").withDistance(1D)
			.withTime(3);
	...
	public static final BuildingLocation PARK_COW_BACK_LEFT = new BuildingLocation(FESTIVAL_GROUNDS, "festival.cow.back.left").withDistance(
			5D);
	...
	public static final BuildingLocation PARK_SHEEP_DANIERU = new BuildingLocation(FESTIVAL_GROUNDS, "festival.sheep.danieru").withDistance(
			5D);
