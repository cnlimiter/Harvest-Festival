...
public class BuildingLocations {
	public static final BuildingLocation FISHING_HUT_UPSTAIRS = new BuildingLocation(HFBuildings.FISHING_HUT, "fisher.upstairs").withDistance(8D);
	...
	public static final BuildingLocation FISHING_HUT_WORK = new BuildingLocation(HFBuildings.FISHING_HUT, "fisher.work").withDistance(1D).withTime(3);
	public static final BuildingLocation FISHING_HUT_RIGHT = new BuildingLocation(HFBuildings.FISHING_HUT, "fisher.right").withDistance(16D);
	...
	public static final BuildingLocation FISHING_POND_CENTRE = new BuildingLocation(HFBuildings.FISHING_HOLE, "pond.water").withDistance(1D);
	...
	public static final BuildingLocation FISHING_POND_RIGHT = new BuildingLocation(HFBuildings.FISHING_HOLE, "pond.right").withDistance(20D);
	...
	public static final BuildingLocation GODDESS_POND_FRONT = new BuildingLocation(HFBuildings.GODDESS_POND, "goddess.front").withDistance(24D);
	public static final BuildingLocation GODDESS_POND_FRONT_LEFT = new BuildingLocation(HFBuildings.GODDESS_POND, "goddess.left").withDistance(24D);
	public static final BuildingLocation GODDESS_POND_FRONT_RIGHT = new BuildingLocation(HFBuildings.GODDESS_POND, "goddess.right").withDistance(24D);
	public static final BuildingLocation GODDESS_POND_BACK_LEFT = new BuildingLocation(HFBuildings.GODDESS_POND, "goddess.left.back").withDistance(16D);
	public static final BuildingLocation GODDESS_POND_BACK = new BuildingLocation(HFBuildings.GODDESS_POND, "goddess.back").withDistance(16D);
	...
	public static final BuildingLocation POULTRY_WORK = new BuildingLocation(HFBuildings.POULTRY_FARM, "poultry.work").withDistance(1D).withTime(3);
	...
	public static final BuildingLocation TOWNHALL_RIGHT = new BuildingLocation(HFBuildings.TOWNHALL, "townhall.wing.right").withDistance(10D);
	public static final BuildingLocation TOWNHALL_RIGHT_OF_STAGE = new BuildingLocation(HFBuildings.TOWNHALL, "townhall.stage.right").withDistance(8D);
	public static final BuildingLocation TOWNHALL_LEFT_OF_STAGE = new BuildingLocation(HFBuildings.TOWNHALL, "townhall.stage.left").withDistance(8D);
	public static final BuildingLocation TOWNHALL_FRONT_OF_STAGE = new BuildingLocation(HFBuildings.TOWNHALL, "townhall.stage.front").withDistance(8D);
	...
	public static final BuildingLocation TOWNHALL_CENTRE = new BuildingLocation(HFBuildings.TOWNHALL, "townhall.entrance").withDistance(10D);
	...
	public static final BuildingLocation CHURCH_PEW_FRONT_LEFT = new BuildingLocation(HFBuildings.CHURCH, "church.pew.left.front").withDistance(3D);
	public static final BuildingLocation CHURCH_PEW_FRONT_RIGHT = new BuildingLocation(HFBuildings.CHURCH, "church.pew.right.front").withDistance(3D);
	...
	public static final BuildingLocation CHURCHPEWBACKLEFT = new BuildingLocation(HFBuildings.CHURCH, "church.pew.left.back").withDistance(3D);
	public static final BuildingLocation CHURCH_PEW_BACK_RIGHT = new BuildingLocation(HFBuildings.CHURCH, "church.pew.right.back").withDistance(3D);
	...
	public static final BuildingLocation GENERAL_CUSTOMER = new BuildingLocation(HFBuildings.SUPERMARKET, "market.customer").withDistance(16D);
	public static final BuildingLocation GENERAL_STORE_FRONT = new BuildingLocation(HFBuildings.SUPERMARKET, "market.front").withDistance(16D);
	...
	public static final BuildingLocation CARPENTER_WORK = new BuildingLocation(HFBuildings.CARPENTER, "carpenter.door").withDistance(1D).withTime(3);
	public static final BuildingLocation CARPENTER_FRONT = new BuildingLocation(HFBuildings.CARPENTER, "carpenter.entrance").withDistance(24D);
	public static final BuildingLocation CARPENTER_DOWNSTAIRS = new BuildingLocation(HFBuildings.CARPENTER, "carpenter.downstairs").withDistance(3D);
	...
	public static final BuildingLocation BLACKSMITH_FRONT = new BuildingLocation(HFBuildings.BLACKSMITH, "blacksmith.entrance").withDistance(16D);
	public static final BuildingLocation BLACKMSITH_DOOR = new BuildingLocation(HFBuildings.BLACKSMITH, "blacksmith.door").withDistance(20D);
	...
	public static final BuildingLocation BLACKSMITH_WORK = new BuildingLocation(HFBuildings.BLACKSMITH, "blacksmith.work").withDistance(1D).withTime(3);
	...
	public static final BuildingLocation PARK_CUSTOMER = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "park.customer").withDistance(3D);
	...
	public static final BuildingLocation PARK_LAMP_BACK = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "park.back.lamps").withDistance(5D);
	public static final BuildingLocation PARK_BACK_LEFT = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "park.back.left").withDistance(5D);
	...
	public static final BuildingLocation PARK_STAGE_RIGHT = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "stage.right").withDistance(0.5D);
	public static final BuildingLocation PARK_STAGE_LEFT = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "stage.left").withDistance(0.5D);
	public static final BuildingLocation PARK_STAGE_STAND1 = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "stage.stand1").withDistance(0.5D);
	public static final BuildingLocation PARK_STAGE_STAND2 = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "stage.stand2").withDistance(0.5D);
	public static final BuildingLocation PARK_STAGE_STAND3 = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "stage.stand3").withDistance(0.5D);
	public static final BuildingLocation PARK_STAGE_STAND4 = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "stage.stand4").withDistance(0.5D);
	...
	public static final BuildingLocation PARK_TRADER_LEFT = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "newyear.left").withDistance(1D);
	public static final BuildingLocation PARK_TRADER_RIGHT = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "newyear.right").withDistance(1D);
	public static final BuildingLocation PARK_NOODLES_STAND = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "noodles").withDistance(1D);
	public static final BuildingLocation PARK_COW_JUDGE = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.cow.candice").withDistance(1D);
	public static final BuildingLocation PARK_COW_BARN = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.cow.jim").withDistance(1D);
	public static final BuildingLocation PARK_COW_BACK = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.cow.back").withDistance(3D);
	public static final BuildingLocation PARK_COW_SEATS = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.cow.seats").withDistance(5D);
	public static final BuildingLocation PARK_COW_BACK_LEFT = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.cow.back.left").withDistance(
			5D);
	public static final BuildingLocation PARK_COW_EDGE = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.cow.edge").withDistance(7D);
	public static final BuildingLocation PARK_COW_BENCH = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.cow.bench").withDistance(4D);
	public static final BuildingLocation PARK_SHEEP_JUDGE = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.sheep.jim").withDistance(1D);
	...
	public static final BuildingLocation PARK_SHEEP_YULIF = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.sheep.yulif").withDistance(5D);
	public static final BuildingLocation PARK_SHEEP_JENNI = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.sheep.jenni").withDistance(5D);
	public static final BuildingLocation PARK_SHEEP_ASHLEE = new BuildingLocation(
			HFBuildings.FESTIVAL_GROUNDS,
			"festival.sheep.ashlee").withDistance(5D);
	public static final BuildingLocation PARK_SHEEP_DANIERU = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.sheep.danieru").withDistance(
			5D);
	public static final BuildingLocation PARK_SHEEP_TIBERIUS = new BuildingLocation(
			HFBuildings.FESTIVAL_GROUNDS,
			"festival.sheep.tiberius").withDistance(5D);
	public static final BuildingLocation PARK_SHEEP_LIARA = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.sheep.liara").withDistance(5D);
	public static final BuildingLocation PARK_SHEEP_JAKOB = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.sheep.jakob").withDistance(5D);
	public static final BuildingLocation PARK_SHEEP_MAYOR = new BuildingLocation(HFBuildings.FESTIVAL_GROUNDS, "festival.sheep.mayor").withDistance(7D);
