...
public class GuiStats extends GuiBaseBook {
	private static final ResourceLocation LEFT_GUI = HarvestFestival.id("textures/gui/book_cooking_left.png");
	private static final ResourceLocation RIGHT_GUI = HarvestFestival.id("textures/gui/book_cooking_right.png");
