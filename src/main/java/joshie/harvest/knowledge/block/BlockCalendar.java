...
public class BlockCalendar extends BlockHFBase<BlockCalendar> {
	...
	protected boolean hasInvalidNeighbor(World world, BlockPos pos) {
		return this.isInvalidNeighbor(world, pos, EnumFacing.NORTH) || this.isInvalidNeighbor(world, pos, EnumFacing.SOUTH) ||
				this.isInvalidNeighbor(world, pos, EnumFacing.WEST) || this.isInvalidNeighbor(world, pos, EnumFacing.EAST);
	}
