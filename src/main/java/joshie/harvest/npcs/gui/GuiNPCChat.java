...
public class GuiNPCChat extends GuiNPCBase {
	...
	private String format(String string) {
		...
		return Util.safeFormat(
				string,
				stats.getGold(),
				playerLover,
				npcLover,
				player.getDisplayNameString(),
				npc.getNPC().getLocalizedName());
	}
	...
	public String getScript() {
		...
		//Info Greeting
		String infoGreeting = !info || npc.getNPC().getInfoButton() == null ? null : npc.getNPC().getInfoButton().getLocalizedText(
				player,
				npc,
				npc.getNPC());
