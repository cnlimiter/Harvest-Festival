...
public class Schedule implements ISchedule {
	...
	public Schedule(ScheduleBuilder builder) {
		...
		for (HolidaySchedule time : builder.holidayScheduleList)
			register(time.festival, time.time, time.location);
	}
	...
	private TreeMap<Long, BuildingLocation> getOrCreateMap(
			HashMap<Festival, TreeMap<Long, BuildingLocation>> holidayMap,
			Festival festival) {
