...
public class GiftsBrandon extends Gifts {
	public GiftsBrandon() {
		...
		stackRegistry.register(HFCooking.MEAL.getStackFromEnum(Meal.RICE_FRIED), Quality.AWESOME);
		...
		stackRegistry.register(HFCooking.MEAL.getStackFromEnum(Meal.JUICE_PINEAPPLE), Quality.DECENT);
		stackRegistry.register(HFCooking.MEAL.getStackFromEnum(Meal.JUICE_GRAPE), Quality.DECENT);
		stackRegistry.register(HFCooking.MEAL.getStackFromEnum(Meal.JUICE_PEACH), Quality.DECENT);
		stackRegistry.register(HFCooking.MEAL.getStackFromEnum(Meal.JUICE_BANANA), Quality.DECENT);
		stackRegistry.register(HFCooking.MEAL.getStackFromEnum(Meal.JUICE_ORANGE), Quality.DECENT);
		stackRegistry.register(HFCooking.MEAL.getStackFromEnum(Meal.JUICE_APPLE), Quality.DECENT);
		stackRegistry.register(HFCooking.MEAL.getStackFromEnum(Meal.JUICE_FRUIT), Quality.DECENT);
		categoryRegistry.put(GiftCategory.ART, Quality.DISLIKE);
		...
		stackRegistry.register(HFCooking.MEAL.getStackFromEnum(Meal.PANCAKE), Quality.DISLIKE);
		categoryRegistry.put(GiftCategory.FRUIT, Quality.DISLIKE);
