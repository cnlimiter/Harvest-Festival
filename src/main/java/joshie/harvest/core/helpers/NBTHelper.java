...
public class NBTHelper {
	...
	public static BlockPos readBlockPos(String prefix, NBTTagCompound tag) {
		return tag.hasKey(prefix + "X") ? new BlockPos(
				tag.getInteger(prefix + "X"),
				tag.getInteger(prefix + "Y"),
				tag.getInteger(prefix + "Z")) : BlockPos.ORIGIN;
	}
	...
	public static NBTTagCompound getLastTickData(NBTTagCompound tag) {
		if (tag.hasKey("LastTickData")) {
			return tag.getCompoundTag("LastTickData");
		} else {
