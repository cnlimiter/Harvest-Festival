...
public class HolderRegistrySet {
	...
	public void unregister(Object object) {
		if (object instanceof Item) {
			unregisterHolder((Item) object, ItemHolder.of((Item) object));
		}
	...
	public void register(Object object) {
		if (object instanceof Item) {
			registerHolder((Item) object, ItemHolder.of((Item) object));
		}
		if (object instanceof Block) {
			ItemStack stack = new ItemStack((Block) object);
			...
			ModHolder holder = ModHolder.of(mod.getMod());
			for (Item item : Item.REGISTRY) {
				if (item.getRegistryName().getResourcePath().equals(mod.getMod())) {
	...
	private AbstractItemHolder getHolder(@Nonnull ItemStack stack) {
		if (stack.getItemDamage() == OreDictionary.WILDCARD_VALUE) {
			return ItemHolder.of(stack.getItem());
		} else if (stack.getItem() instanceof ItemHFSizeable) {
			return SizeableHolder.of(stack);
