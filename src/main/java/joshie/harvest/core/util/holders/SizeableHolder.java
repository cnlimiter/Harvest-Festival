...
public class SizeableHolder extends AbstractItemHolder {
	...
	public String toString() {
		return "SizeableHolder:" + (
				!stack.isEmpty() ?
						stack.getItem().getRegistryName() + " " + stack.getItemDamage() + " item: " +
								(item != null ? ((Item) item).getRegistryName() : "null") :
						"null");
	}
	...
	public boolean equals(Object o) {
		...
		return item != null ?
				...
				that.item == null && (object != null ? object.equals(that.object) : that.object == null);
	}
