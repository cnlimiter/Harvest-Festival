...
public enum AnimalTest {
	CAN_CLEAN, //If the animal can be cleaned at all
	IS_CLEAN, //If the animal is clean
	HAS_EATEN, //If the animal has eaten today
	IS_SICK, //If the animal is sick
	...
	WON_CONTEST //If the animal has won a contest
}