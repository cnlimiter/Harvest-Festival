...
public abstract class GrowthHandler<C extends Crop> {
	 ...
	 * @param crop   the crop
	 * @param flagIn debug mode?
	 **/
	@SideOnly(Side.CLIENT)
	public void addInformation(List<String> list, C crop, ITooltipFlag flagIn) {
	...
	public boolean canPlantSeedAt(World world, BlockPos pos, IBlockState soil, C crop, BlockPos original) {
		return soil != Blocks.AIR && soil.getBlock().canSustainPlant(soil, world, pos.down(), EnumFacing.UP, crop) &&
