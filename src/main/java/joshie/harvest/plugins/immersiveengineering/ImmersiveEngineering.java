...
public class ImmersiveEngineering {
	...
	public static void preInit() {
		HEMP = new Crop(new ResourceLocation("immersiveengineering", "hemp")).setValue(1000, 1)
				.setStages(15)
				.setRegrow(1)
				.setSeedColours(0xB57449)
				.setSeasons(Season.SPRING, Season.SUMMER, Season.AUTUMN)
				.setStateHandler(new StateHandlerHemp(() -> hemp_block))
				.setSkipRender()
				.setAnimalFoodType(null)
				.setRequiresSickle(15)
				.setGrowthHandler(new HempGrowthHandler())
				.setBecomesDouble(15);
	}
