...
public class HFCooking {
	...
	public static void preInit() {
		...
		HFApi.shipping.registerSellable(
				new ItemStack(Items.PUMPKIN_PIE),
				(long) ((10 + HFCrops.PUMPKIN.getSellValue() + Sizeable.EGG.getSmall()) * COOKING_SELL_MODIFIER));
		HFApi.shipping.registerSellable(
				new ItemStack(Items.COOKIE),
				(long) ((Ingredient.FLOUR.getCost() + Ingredient.CHOCOLATE.getCost()) * COOKING_SELL_MODIFIER) / 4);
		HFApi.shipping.registerSellable(
				new ItemStack(Items.CAKE),
				(long) ((10 + Ingredient.FLOUR.getCost() + Sizeable.MILK.getSmall() + Sizeable.EGG.getSmall()) * COOKING_SELL_MODIFIER));
		HFApi.shipping.registerSellable(
				new ItemStack(Items.BEETROOT_SOUP),
				(long) (
						(
								10 + Ingredient.OIL.getCost() + HFCrops.BEETROOT.getSellValue() + HFCrops.ONION.getSellValue() +
										HFCrops.TOMATO.getSellValue()) * COOKING_SELL_MODIFIER));
		HFApi.shipping.registerSellable(
				new ItemStack(Items.RABBIT_STEW),
				(long) ((bakedPotato + HFCrops.CARROT.getSellValue() + cookedRabbit + brownMushroom) * COOKING_SELL_MODIFIER));
