		...
		if (tile instanceof TileOven) {
			...
			if (orientation == EnumFacing.NORTH || orientation == EnumFacing.SOUTH) {
				world.spawnParticle(
						...
						getPos().getX() + 0.2D + (world.rand.nextInt(10) / 100D),
						getPos().getY() - 0.115D,
						getPos().getZ() + 0.265D + (world.rand.nextInt(15) / 100D),
						0,
						0,
						0);
				world.spawnParticle(
						...
						getPos().getX() + 0.2D + (world.rand.nextInt(10) / 100D),
						getPos().getY() - 0.115D,
						getPos().getZ() + 0.735D - (world.rand.nextInt(15) / 100D),
						0,
						0,
						0);
				world.spawnParticle(
						EnumParticleTypes.FLAME,
						getPos().getX() + 0.8D - (world.rand.nextInt(10) / 100D),
						getPos().getY() - 0.115D,
						getPos().getZ() + 0.265D + (world.rand.nextInt(15) / 100D),
						0,
						0,
				...
				world.spawnParticle(
						EnumParticleTypes.FLAME,
						getPos().getX() + 0.265D + (world.rand.nextInt(15) / 100D),
						getPos().getY() - 0.115D,
						getPos().getZ() + 0.2D + (world.rand.nextInt(10) / 100D),
						0,
						0,
						0);
				world.spawnParticle(
						EnumParticleTypes.FLAME,
						getPos().getX() + 0.735D - (world.rand.nextInt(15) / 100D),
						getPos().getY() - 0.115D,
						getPos().getZ() + 0.2D + (world.rand.nextInt(10) / 100D),
						0,
						0,
				...
				world.spawnParticle(
						...
						getPos().getX() + 0.265D + (world.rand.nextInt(15) / 100D),
						getPos().getY() - 0.115D,
						getPos().getZ() + 0.8D - (world.rand.nextInt(10) / 100D),
						0,
						0,
						0);
				world.spawnParticle(
			...
			world.spawnParticle(
					...
					getPos().getX() + 0.4D + (world.rand.nextInt(20) / 100D),
					getPos().getY() - 0.2D,
					getPos().getZ() + 0.4D + (world.rand.nextInt(20) / 100D),
					0,
					0,
					0);
		}
